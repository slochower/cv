...
\begin{itemize}
    \item Proficient programming in Python and Jupyter Notebooks with knowledge of Bash, C++, FORTRAN, and Perl.
    \item Active user of GitHub and continuous integration platforms.
    \item Experience writing unit, integration, and regression tests.
